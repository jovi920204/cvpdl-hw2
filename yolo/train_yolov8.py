...
def main(mode, dataset_path, epochs, imgsz, pretrained_model):
    ...
    if mode == "scratch":
        ...
        results = train_model(model, dataset_path, epochs, imgsz, resume=True)
...
if __name__ == "__main__":
    ...
    main(args.mode, args.dataset, args.epochs, args.imgsz, args.pretrained_model)